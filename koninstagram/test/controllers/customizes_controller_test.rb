...
class CustomizesControllerTest < ActionController::TestCase
  ...
  test "should create customize" do
    assert_difference('Customize.count') do
      post :create, customize: { color: @customize.color, material: @customize.material, user_id: @customize.user_id, waku: @customize.waku }
    end
  ...
  test "should update customize" do
    patch :update, id: @customize, customize: { color: @customize.color, material: @customize.material, user_id: @customize.user_id, waku: @customize.waku }
    assert_redirected_to customize_path(assigns(:customize))
  end
